...
namespace CookBook.Api.Tests
{
    public class IngredientControllerTests : IntegrationTest
    {
        ...
        [Fact]
        public async Task GetAll_Should_Return_Four_Ingredients()
        {
            // Act
            ...
            ingredients[2].Name.Should().Be("Šlehačka");
            ingredients[3].Name.Should().Be("Brambora");
        }

        [Theory]
        [InlineData("df935095-8709-4040-a2bb-b6f97cb416dc", "Vejce", "Popis vejce")]
        ...
        {
            // Arrage
            var ingredientToDeleteGuid = new Guid("88926e83-1d41-491d-8255-bc0dd1fcc43e");
