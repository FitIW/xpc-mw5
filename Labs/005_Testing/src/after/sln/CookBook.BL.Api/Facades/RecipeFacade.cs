...
namespace CookBook.BL.Api.Facades
{
    public class RecipeFacade : IAppFacade
    {
        ...
        private void UpdateIngredientAmounts(RecipeEntity recipeEntity, IEnumerable<RecipeDetailIngredientModel> recipeUpdateIngredientModelsToUpdate)
        {
        ...
        private void InsertIngredientAmounts(RecipeEntity recipeEntity, IEnumerable<RecipeDetailIngredientModel> recipeUpdateIngredientModelsToInsert)
        {
